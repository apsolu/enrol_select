...
class role {
    ...
    public static function deleted(role_deleted $event) {
        ...
        // Supprime les références du rôle supprimé dans la table enrol_select_roles.
        $DB->delete_records('enrol_select_roles', ['roleid' => $event->objectid]);

        // Supprime les références du rôle supprimé dans la table enrol_select_cohorts_roles.
        $DB->delete_records('enrol_select_cohorts_roles', ['roleid' => $event->objectid]);
    }
}
