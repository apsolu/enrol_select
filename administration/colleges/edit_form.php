...
class apsolu_colleges_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addHelpButton('maxwish', 'maximum_wishes', 'enrol_select');
        ...
        $mform->addHelpButton('minregister', 'minimum_enrolments', 'enrol_select');
        ...
        $mform->addHelpButton('maxregister', 'maximum_enrolments', 'enrol_select');
