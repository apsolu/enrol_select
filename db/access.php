...
/**
 * Capabilities for select enrolment plugin.
 *
...
$capabilities = array(
    ...
    'enrol/select:unenrolself' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
